  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col  justify-center bg-white font-sans min-w-full ">
        <div className="relative overflow-visible bg-[#f6f9ff] w-full bg-none md:bg-[url('/assets/p-home-pic.webp')] md:bg-no-repeat md:bg-left md:bg-auto">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center py-20 px-6 md:px-40">
            ...
            <div className=" flex items-center flex-col md:flex-row gap-5">
              ...
              <a
                href="https://pubrio.pxf.io/dONgNW"
                className="mt-4 inline-block  text-blue-700 font-semibold border border-blue-600 px-6 py-3 rounded-lg shadow-md hover:bg-blue-700 hover:text-white transition-colors duration-300">
                Learn How Pubrio Works
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-[#f6f9ff] px-6 md:px-40 py-12 md:bg-[url('/assets/p-home-pic2.webp')] md:bg-no-repeat md:bg-right md:bg-auto flex flex-col items-center justify-center">
          ...
          <a
            href="https://how-it-works"
            className="mt-10 inline-block  text-blue-700 font-semibold border border-blue-600 px-6 py-3 rounded-lg shadow-md hover:bg-blue-700 hover:text-white transition-colors duration-300">
        ...
        <div className="mt-8  px-6 md:px-40 py-12">
          ...
          <div className="flex flex-col gap-4  items-center justify-center mt-8">
            ...
            <a
              href="https://how-it-works"
              className="mt-10 inline-block  text-white bg-blue-600 font-semibold border border-blue-600 px-6 py-3 rounded-lg shadow-md hover:bg-blue-700 transition-colors duration-300">
              👉 View Use Cases
            </a>
          </div>
        </div>
